...
'bibliotheque': {
  title: "Bibliothèque",
  description: "Cette pièce est à la fois une bibliothèque et un bureau. Son unique fenêtre — une ouverture assez étroite, située tout en haut du mur nord — est fermée par un volet de bois et condamnée ; aussi les seules sources d'éclairage se réduisent-elles aux lueurs tamisées des lampes à pétrole disposées dans toute la pièce, sur des supports de cuivre poli. Us livres alignés sur les rayonnages comme les soldats d'une antique armée sont principalement des ouvrages historiques consacrés au passé tumultueux de la Transylvanie. Sur un bureau et une table voisine sont éparpillés des journaux et des magazines ; en les examinant de plus près, on s'aperçoit qu'ils sont tous écrits en anglais : London Illustrated News... Times... Manchester Guardian... Sporting Life... Rod and Gun... Tatler... Punch... London Charivari... On ne peut pénétrer dans cette pièce ou en sortir que par une seule issue : la porte aménagée dans le mur sud.",
